...
return{
    init: function(walletPath, channelId, networkUrl, ordererUrl) {
    ...
    query: function(chaincodeId, fcn, args = []) {
    ...
    installChaincode:function(peers, chaincodeName, chaincodePath,
