...
return{
    ...
    query_checkDataVaild: function(req, res){
		console.log("controller checkDataVaild: ");
        
        var array = req.params.CDV.split(",");
        console.log(array);
        
        var Key = array[0];
        var NowTimeStamp = array[1].replace(/-/g, "/");
